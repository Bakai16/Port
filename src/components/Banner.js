...
// variants
import { fadIn, fadeIn } from "../variants";
        ...
        >
            <div className="container mx-auto">
                <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
                    {/* text */}
                    <div className="flex-1 text-center font-secondory lg:text-left">
                        <motion.h1
                        ...
                        <motion.p
                         ...
                         className="mb-6 max-w-lg mx-auto lg:mx-0">
                            ...
                            elit. Voluptatum ipsum doloremque neque quos quis
                            soluta dolores aperiam a iure ab!
                        </motion.p>
                        <motion.div
